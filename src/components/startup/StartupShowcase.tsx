...
const StartupShowcase: React.FC<ExtendedStartupShowcaseProps> = ({
  ...
  // Function to handle the logo URL correctly based on the backend implementation
                ...
                >
                  <Link to={`/startup-profile/${startup._id}`}>
                    <div className="bg-indigo-50 p-6 flex items-center justify-center">
                      <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-white flex items-center justify-center p-2 overflow-hidden">
                        {startup.logo ? (
                          <img
                          ...
                          <div className="text-4xl md:text-5xl font-bold text-indigo-300">
...
//   // Function to handle the logo URL correctly based on the backend implementation
//   const getLogoUrl = (startup: Startup) => {
//     // Check if logo exists and has a url property
//     if (startup.logo && typeof startup.logo === 'object' && 'url' in startup.logo) {
//       return startup.logo.url;
//     }
    
//     // If logo is just a string (perhaps an old format)
//     if (startup.logo && typeof startup.logo === 'string') {
//       return startup.logo;
//     }
