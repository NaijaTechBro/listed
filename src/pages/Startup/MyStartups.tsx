...
const MyStartups: React.FC = () => {
  // Use the startup context directly instead of outlet context
  const { 
    userStartups, 
    loading, 
    deleteStartup, 
  ...
  const handleDeleteStartup = async () => {
    ...
    try {
      ...
      // After deletion, refresh the user startups list
        ...
        <AnimatePresence>
          {loading ? (
            ...
            >
              ...
              <p className="mt-4 text-gray-600">Loading your startups...</p>
            </motion.div>
              ...
              >
                ...
                <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="button"
                    className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 text-base font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
